                            ...
                            <div class="col-md-6">
                                <div class="form-group  ml-n2">
                                    ...
                                    <select name="customer_type" id="customer_type" class="form-control">
                                        <option value="">Walking Cutomer</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group  ml-n2">
                                    ...
                                    <input type="text" class="form-control " placeholder="Set Table No"
                                        id="destination_no" autocomplete="off" name="destination_no"
                                        value="{{ old('destination_no') }}" required>
                            ...
                            <table class="table table-sm table-hover " style="  min-height: 10vh; ">
                                ...
                                <tr>
                                    ...
                                    <td> <select name="payment_type" class="form-control form-control-sm  float-right"
                                            ...
                                            <option value="1" {{ (old('customer_type')!==0 || old('customer_type')!==1)?'disabled':'' }} >Account</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
    ...
    <script>
        ...
        $(function() {
            ...
            $('#customer_type').on('change', function() {
                ...
                {
                    $("#payment_type option[value='0']").attr("disabled",false);
        ...
        function calculateSetServiceChargeAndTax(discount =0) {
            ...
            if (temp_total >= 0) {
                ...
                let tax_amount = parseFloat(((parseFloat(temp_total) + parseFloat(service_charge_amount)) * (tax / 100)).toFixed(2));
